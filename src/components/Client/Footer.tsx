...
const Footer = (props: Props) => {
  return (
    <footer className="px-4 divide-y bg-[#172337] text-coolGray-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <a href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-24 h-12 rounded-full bg-white-600">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-white">Clothing</h3>
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-white">Accessories</h3>
            <ul className="space-y-1 text-white">
              <li>
                <a href="#">Watches</a>
              </li>
          ...
          <div className="space-y-3">
            <h3 className="uppercase text-white">Brands</h3>
            <ul className="space-y-1 text-white">
              <li>
